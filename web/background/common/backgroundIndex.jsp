...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="./index.jsp">天天新闻1.0</a></div>
    <div class="left_open">
    ...
    <ul class="layui-nav right" lay-filter="">
        ...
        <li class="layui-nav-item to-index"><a href="/GoIndex">前台首页</a></li>
    </ul>
...
<!-- 底部开始 -->
<div class="footer">
    <div class="copyright">Copyright ©2019 天天新闻1.0 All Rights Reserved</div>
</div>
<!-- 底部结束 -->
</body>
</body>
